...
x <- readRDS("\\\\deqhq1\\tmdl\\TMDL_WR\\MidCoast\\Models\\Dissolved Oxygen\\Middle_Siletz_River_1710020405\\001_data\\metabolism\\data.DO.metab.NAreplce_2.RData")
...
for (i in 1 : length(STAID))
{
    ...
    print(paste0("Station ", STA[i], ", Cold-water at ",
                 Sys.time()," -- ", round(100 * perc.comp, 0), "% COMPLETE"))
    ...
    print(paste0("Station ", STA[i], ", Spawning at ",
                 Sys.time()," -- ", round(100 * perc.comp, 0), "% COMPLETE"))
}
...
saveRDS(metab.output.all,
        "\\\\deqhq1\\tmdl\\TMDL_WR\\MidCoast\\Models\\Dissolved Oxygen\\Middle_Siletz_River_1710020405\\001_data\\metabolism\\Metab_Output_MLE_all_wDepth.RData")
